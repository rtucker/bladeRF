...
/**
 * If a function is only supported on a bladeRF 1 but it is called with a
...
int bladerf_set_lpf_mode(struct bladerf *dev,
                         bladerf_channel ch,
...
int bladerf_get_lpf_mode(struct bladerf *dev,
                         bladerf_channel ch,
                         bladerf_lpf_mode *mode)
{
    int status;
